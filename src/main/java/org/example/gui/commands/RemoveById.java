...
public class RemoveById implements Command {
    ...
    public String toString() {
        return ManagerLanguage.get("command.remove_by_id");
    }

    @Override
    public void executeCommand(String[] args, SocketChannel serverChannel, Object object) {
        ManagerCommands.addToHistory("remove_by_id");
        Main.send(new CommandPacket("remove_by_id", args, (RouteClient) object,
